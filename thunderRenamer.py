...
appPath = os.path.join(os.path.abspath('data.json').replace('data.json', ''), '_internal')
print(appPath)
...
win.resize(600,400)
print(os.path.abspath('thunderRenamer.png').replace('thunderRenamer.png', '_internal\\thunderRenamer.png'))
